...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var routes = <String, WidgetBuilder>{
      ...
      MySubscriptionPage.routeName: (BuildContext context) => new MySubscriptionPage(title: "Subscription Page"),
...
class _MyHomePage extends State<MyHomePage> {
      ...
      home: Scaffold(
        ...
        body: Center(
          ...
          children: [
            ...
            ElevatedButton(child: Text('Subscribe Location/Events'), onPressed: _onSubscriptionButtonPressed),
  ...
  void _onSubscriptionButtonPressed() {
    Navigator.pushNamed(context, MySubscriptionPage.routeName);
  }
...
class _MyItemsPageState extends State<MyItemsPage> {
  ...
  // Future<void> _displayTripsInputDialog(BuildContext context, String type) async {
  //   return showDialog(
  //       context: context,
  //       builder: (context) {
  //         return AlertDialog(
...
class MySubscriptionPage extends StatefulWidget {
  MySubscriptionPage({super.key, required this.title});
  static const String routeName = "/MySubscriptionPage";
  final String title;
  @override
  _MySubscriptionPageState createState() => new _MySubscriptionPageState();
}
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: TextField(
              ...
              controller: _textFieldController,
              decoration: InputDecoration(hintText: "active/passive/balanced/custom/time/distance"),
            ),
            actions: <Widget>[
              TextButton(
                style: ButtonStyle(
