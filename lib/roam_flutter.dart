...
import './json/JsonDecoder.dart';
import './RoamTrackingMode.dart';
import './json/JsonEncoder.dart';
import './trips_v2/RoamTrip.dart';
import './trips_v2/callback/ErrorCallback.dart';
import './trips_v2/callback/RoamTripCallback.dart';
import './trips_v2/callback/RoamSyncTripCallback.dart';
import './trips_v2/callback/RoamDeleteTripCallback.dart';
import './trips_v2/callback/RoamActiveTripsCallback.dart';

/// This is a callback function for the Roam Flutter SDK
typedef RoamCallBack = void Function({String? location});

/// This is a callback function for the Roam Flutter SDK when it is related
/// to a user
typedef RoamUserCallBack = void Function({String? user});

/// This is a callback function for the Roam Flutter SDK when it is related
/// to a trip
typedef RoamTripCallBack = void Function({String? trip});

/// This is a callback function for the Roam Flutter SDK when it is related
/// to a location
typedef RoamLocationCallback = void Function(Map? location);
...
class Roam {
  ...
  static const String METHOD_DISABLE_BATTERY_OPTIMIZATION = "disableBatteryOptimization";
  ...
  static const MethodChannel _channel = MethodChannel('roam_flutter');
  static late RoamCallBack _callBack;
  static late RoamUserCallBack _userCallBack;
  static late RoamTripCallBack _tripCallBack;

  static const EventChannel _locationEventChannel = EventChannel('roam_flutter_event/location');
  ...
  static Future<bool?> initialize({
    ...
    final Map<String, dynamic> params = <String, dynamic>{'publishKey': publishKey};
  ...
  /// Returns Roam User
  static Future<void> createUser({required String description, required RoamUserCallBack callBack}) async {
    final Map<String, dynamic> params = <String, dynamic>{'description': description};
    final String? result = await _channel.invokeMethod(METHOD_CREATE_USER, params);
  ...
  /// Returns Roam User
  static Future<void> getUser({required String userId, required RoamUserCallBack callBack}) async {
  ...
  /// Returns Roam User
  static Future<void> toggleListener({required bool events, bool? locations, required RoamUserCallBack callBack}) async {
    final Map<String, dynamic> params = <String, dynamic>{'events': events, 'locations': locations};
    final String? result = await _channel.invokeMethod(METHOD_TOGGLE_LISTENER, params);
    callBack(user: result);
  }
  ...
  /// Returns Roam User
  static Future<void> toggleEvents({required bool location, bool? geofence, bool? trips, bool? movingGeofence, required RoamUserCallBack callBack}) async {
    final Map<String, dynamic> params = <String, dynamic>{'geofence': geofence, 'location': location, 'trips': trips, 'movingGeofence': movingGeofence};
    final String? result = await _channel.invokeMethod(METHOD_TOGGLE_EVENTS, params);
    callBack(user: result);
  }
  ...
  /// Accepts Roam User Id in String Format
  /// Returns Roam User
  static Future<void> getListenerStatus({required RoamUserCallBack callBack}) async {
    final String? result = await _channel.invokeMethod(METHOD_GET_LISTENER_STATUS);
    callBack(user: result);
  }
  ...
  /// Returns void
  static Future<void> setForeground(bool enabled, String title, String description, String icon, String activity) async {
  ...
  /// Returns Location
  static Future<bool?> updateCurrentLocation({required int accuracy, Map<String, dynamic>? jsonObject}) async {
    ...
    final bool? result = await _channel.invokeMethod(METHOD_UPDATE_CURRENT_LOCATION, params);
    _channel.setMethodCallHandler(_methodCallHandler);
    return result;
  }
  ...
  /// Accepts Accuracy Value in Int format
  /// Returns Location
  static Future<void> getCurrentLocation({required int accuracy, required RoamCallBack callBack}) async {
    final Map<String, dynamic> params = <String, dynamic>{'accuracy': accuracy};
    final String? result = await _channel.invokeMethod(METHOD_GET_CURRENT_LOCATION, params);
    callBack(location: result);
  }

  static Future<bool?> startTracking({required dynamic trackingMode, Map? customMethods}) async {
    final Map<String, dynamic> params = <String, dynamic>{'trackingMode': trackingMode, 'customMethods': customMethods};
    final bool? result = await _channel.invokeMethod(METHOD_START_TRACKING, params);
    return result;
  }
  ...
  static Future<bool?> disableBatteryOptimization() async {
    try {
      final bool? result = await _channel.invokeMethod(METHOD_DISABLE_BATTERY_OPTIMIZATION);
      _channel.setMethodCallHandler(_methodCallHandler);
      return result;
    } catch (error) {
  ...
  static Future<bool?> subscribeUserLocation({
    ...
    final Map<String, dynamic> params = <String, dynamic>{'userId': userId};
    final bool? result = await _channel.invokeMethod(METHOD_SUBSCRIBE_USER_LOCATION, params);
    _channel.setMethodCallHandler(_methodCallHandler);
    return result;
  }
  ...
  static Future<bool?> enableAccuracyEngine() async {
    final bool? result = await _channel.invokeMethod(METHOD_ENABLE_ACCURACY_ENGINE);
    _channel.setMethodCallHandler(_methodCallHandler);
    return result;
  }
  ...
  static Future<bool?> disableAccuracyEngine() async {
    final bool? result = await _channel.invokeMethod(METHOD_DISABLE_ACCURACY_ENGINE);
    _channel.setMethodCallHandler(_methodCallHandler);
    return result;
  }

  static Future<void> createTrip(RoamTrip roamTrip, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
    ...
    try {
      ...
      log('response error: $exception');
    }
  }

  static Future<void> updateTrip(RoamTrip roamTrip, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
    roamTrip.tripId ??= '';
    Map<String, dynamic> json = JsonEncoder.encodeRoamTrip(roamTrip);
  ...
  static Future<void> getTripDetails({required String tripId, required RoamTripCallBack callBack}) async {
    final Map<String, dynamic> params = <String, dynamic>{'tripId': tripId};
    final String? result = await _channel.invokeMethod(METHOD_GET_TRIP_DETAILS, params);
    callBack(trip: result);
  }

  static Future<void> getTripStatus({required String tripId, required RoamTripCallBack callBack}) async {
    final Map<String, dynamic> params = <String, dynamic>{'tripId': tripId};
    final String? result = await _channel.invokeMethod(METHOD_GET_TRIP_STATUS, params);
    callBack(trip: result);
  }
  ...
  static Future<bool?> subscribeTripStatus({
    ...
    final Map<String, dynamic> params = <String, dynamic>{'tripId': tripId};
    final bool? result = await _channel.invokeMethod(METHOD_SUBSCRIBE_TRIP_STATUS, params);
    _channel.setMethodCallHandler(_methodCallHandler);
    return result;
  }
  ...
  static Future<bool?> ubSubscribeTripStatus({
    ...
    final Map<String, dynamic> params = <String, dynamic>{'tripId': tripId};
    final bool? result = await _channel.invokeMethod(METHOD_UNSUBSCRIBE_TRIP_STATUS, params);
    _channel.setMethodCallHandler(_methodCallHandler);
    return result;
  }

  static Future<void> allowMockLocation({required bool allow}) async {
  ...
  static Future<void> pauseTrip(String tripId, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
  ...
  static Future<void> resumeTrip(String tripId, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
  ...
  static Future<void> endTrip(String tripId, bool stopTracking, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
    Map<String, dynamic> json = {};
    json['tripId'] = tripId;
  ...
  static Future<void> deleteTrip(String tripId, RoamDeleteTripCallback roamDeleteTripCallback, ErrorCallback errorCallback) async {
  ...
  static Future<void> getTrip(String tripId, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
    debugPrint('get trip id: $tripId');
  ...
  static Future<void> syncTrip(String tripId, RoamSyncTripCallback roamSyncTripCallback, ErrorCallback errorCallback) async {
  ...
  static Future<void> getActiveTrips(bool isLocal, RoamActiveTripsCallback roamActiveTripsCallback, ErrorCallback errorCallback) async {
    ...
    try {
      ...
      if (json.containsKey("error")) {
        ...
        roamActiveTripsCallback(roamActiveTripResponse: JsonDecoder.decodeRoamActiveTripResponse(json));
      }
    } catch (exception) {
      log(exception.toString());
    }
  ...
  static Future<void> getTripSummary(String tripId, RoamTripCallback roamTripCallback, ErrorCallback errorCallback) async {
  ...
  static Future<void> _methodCallHandler(MethodCall call) async {
    switch (call.method) {
      ...
      default:
        debugPrint('This normally shouldn\'t happen.');
    }
  }

  /// Platform messages are asynchronous, so we initialize in an async method.
  /// Platform messages may fail, so we use a try/catch PlatformException.
  /// We also handle Platform messages manually.
  ///
  /// This method is specifically used to get the platform version.
