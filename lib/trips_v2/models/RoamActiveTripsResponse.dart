...
class RoamActiveTripResponse {
  ...
  RoamActiveTripResponse(this.code, this.message, this.description, this.hasMore, this.trips);

  Map toJson() => {'code': code, 'message': message, 'description': description, 'hasMore': hasMore, 'trips': getTripMapList(trips)};
